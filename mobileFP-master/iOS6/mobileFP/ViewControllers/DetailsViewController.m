...
//    NSLayoutConstraint *constrant1 = [NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:view.superview attribute:NSLayoutAttributeCenterX multiplier:1.0 constant:0.0];
//    NSArray *array = [NSArray arrayWithObjects:constrant1, nil];
