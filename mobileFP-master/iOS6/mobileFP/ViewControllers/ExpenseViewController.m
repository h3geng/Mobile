...
// comment this in order to avoid bugs (the screen is bouncing when input the value of miles)
...
- (void)textFieldDidChange:(UITextField *)textField {
    switch (textField.tag) {
        case 13:{
            ...
            [self.tableView reloadRowsAtIndexPaths:[NSArray arrayWithObjects:[NSIndexPath indexPathForRow:3 inSection:3], nil] withRowAnimation:UITableViewRowAnimationNone];
            break;
        }
        case 15:{
            _expense.tip = [textField.text doubleValue];
